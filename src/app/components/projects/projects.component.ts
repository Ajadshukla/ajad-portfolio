    ...
    <section id="projects" class="py-24 bg-dark-800/50 relative overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16 reveal">
          ...
          <h2 class="section-title text-ink">Featured <span class="gradient-text">Projects</span></h2>
              ...
              <div class="p-6 md:p-8">
                ...
                <div class="flex items-start justify-between gap-4 mb-4">
                  <div>
                    ...
                    <h3 class="font-display font-bold text-xl text-ink">{{ project.title }}</h3>
                ...
                <!-- Actions -->
                <div class="flex items-center gap-3 pt-2 border-t border-[var(--glass-border)]">
                  @if (project.githubUrl) {
                    <a
                      [href]="project.githubUrl"
                      target="_blank"
                      rel="noopener noreferrer"
                      class="flex items-center gap-2 text-sm text-slate-400 hover:text-ink transition-colors font-medium group/link">
